...
| Re-Edit Private Signs          | Makes it possible to edit private signs after being placed with the normal sign GUI. (*not on 1.20.1*)                                                                                                                                                                                                                                                                                                      |
| Mob Arena Helper               | Provides a consistent on-screen wave count/progress hud item.                                                                                                                                                                                                                                                                                                                                               |
